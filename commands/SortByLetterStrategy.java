...
/** Стратегия сортировки по текстовому полю (letter). */
public class SortByLetterStrategy implements CollectionStrategy {
    ...
    public void execute(List<Data> input) {
        ...
        // Если нужно без учёта регистра — раскомментируй следующую строку,
        // а нижнюю закомментируй.
        // Comparator<Data> cmp = Comparator.comparing(Data::getLetter, String.CASE_INSENSITIVE_ORDER);
        Comparator<Data> cmp = Comparator.comparing(Data::getLetter);
